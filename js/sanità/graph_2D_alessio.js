$(document).ready(async function () {
    //TODO: fixare prima data, colori ed estetica bottoni
    ...
    // let clientHeight = document.getElementById('#graph_2D').clientHeight;
    // let clientWidth = document.getElementById('#graph_2D').clientWidth;


    console.log("Y " + clientHeight)
    console.log("X " + clientWidth)
    console.log(typeof clientWidth)
    ...
    addEventListener("mouseover", function (e) {
        let auxDrop = document.getElementById("ddlViewBy").value;
